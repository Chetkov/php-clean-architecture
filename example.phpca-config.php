...
return [
    ...
    'restrictions' => [
        ...
        // Общий список РАЗРЕШЕННЫХ исходящих зависимостей. Заполняется именами других модулей.
        // Может отсутствовать, быть [] или null.
        // Не должен содержать значений, перечисленных в элементе forbidden_dependencies!
        // 'allowed_dependencies' => ['SecondModule'],

        // Общий список ЗАПРЕЩЕННЫХ исходящих зависимостей. Заполняется именами других модулей.
        // Может отсутствовать, быть [] или null.
