...
return [
    ...
    // Необязательная область сканирования для debug-команды:
    // vendor/bin/phpca-debug-unmatched-files phpca-config.php
    //
    // Если не задано, команда сама выберет общий родитель component roots.
    // Для sub-конфигов по умолчанию используется root родительского компонента.
    // 'debug_scan_paths' => [
    //     __DIR__ . '/src',
    // ],
