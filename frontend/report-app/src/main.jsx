  ...
  return (
    <section className="panel chart-panel">
      ...
      <svg viewBox="0 0 360 240" role="img" aria-label={t('aiMatrix')}>
        ...
        <text className="zone-label pain" textAnchor="middle" x="77" y="178">{t('zoneOfPain')}</text>
        <text className="zone-label uselessness" textAnchor="middle" x="282" y="50">{t('zoneOfUselessness')}</text>
